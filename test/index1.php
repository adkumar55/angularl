...
"></span>
						...
						<div class="col-md-10 column col-xs-height" data-column="1">
							...
							<div class="tool-result-summary">
								The meta title of your page has a length of 44 characters. Most search engines will truncate meta titles to 70 characters.
...
<strong>Example:</strong><br>
					...
					<div class="row results-line row-same-height subresult2">
						...
						<div class="col-md-10 column col-xs-height" data-column="1">
							<span class="icon cancel-circle2" aria-hidden="true" data-container="body" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="This needs to be fixed"></span>
							<div class="tool-result-summary">
								Your page does not contain any H2 headings. H2 headings help describe the sub-topics of your webpage to search engines. While less important than good meta-titles and descriptions, H1 and H2 headings may still help define the topics of your page to search engines.
								<br>
								<a href="#" class="how-to-fix" data-toggle="modal" data-target="#howToFixModal">How to Fix</a>
					...
					<div class="row results-line row-same-height subresult1" style="border-bottom:none;">
						...
						<div class="col-md-10 column col-xs-height" data-column="1">
							...
							<div class="tool-result-summary">
								...
								<div class="tool-result-details">
									<span class="icon arrow-right32" aria-hidden="true"></span>
									<em><a href="http://aequor.com/sitemap.xml" target="_blank">http://aequor.com/sitemap.xml</a></em>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="broken_links">
					<div class="row results-line row-same-height subresult1" style="border-bottom:none;">
						...
						<div class="col-md-10 column col-xs-height" data-column="1">
							...
							<div class="tool-result-summary">
								From 44 distinct anchor links analyzed, none of them appear to be broken.
							</div>
						</div>
					</div>
				...
				<div class="img_alt">
					<div class="row results-line row-same-height subresult1">
						...
						<div class="col-md-10 column col-xs-height" data-column="1">
							...
							<div class="tool-result-summary">
								Your webpage has <strong>42</strong> 'img' tags and <strong>6</strong> of them are missing&nbsp;the required 'alt' attribute.
